...
public class OntologyMultiplier {
	...
	public void mergeOntologies(String[] ontPaths) throws Exception {
		OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
		for(String ontPath : ontPaths) {
	        File owlFile = new File(ontPath);
	        IRI documentIRI = IRI.create(owlFile);
	        OWLOntology ontToBeMerged = 
	        	manager.loadOntologyFromOntologyDocument(documentIRI); 
	        System.out.println("No of logical axioms: " + 
	        		ontToBeMerged.getLogicalAxiomCount());
		}
		OWLOntologyMerger merger = new OWLOntologyMerger(manager);
		IRI mergedOntologyIRI = IRI.create(new File("mergedOntology.owl"));
